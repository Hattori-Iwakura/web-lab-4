...
namespace web_lab_4.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        {
            _logger.LogInformation($"External login request for provider: {provider}");
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            _logger.LogInformation($"External login info received for provider: {info.LoginProvider}");
